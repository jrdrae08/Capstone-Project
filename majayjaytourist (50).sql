...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2024 at 05:01 PM
...
(20, 52, 'Jordan Rae Marabe', '121 Street', 'jopetsalazar23@gmail.com', '09567465432', 4, 4, 4, 4, 4, 0, 0, 4, '2024-10-29', '2024-10-30', 'REF-U7KCCH', '2024-10-13 20:48:03', 'Accepted'),
(21, 52, 'Jopay Manalo', '1231 Street', 'joasjdsoad9@gmail.com', '09465762543', 6, 0, 3, 3, 2, 1, 3, 0, '2024-10-14', '2024-10-15', 'REF-SJ0DFW', '2024-10-13 22:36:35', 'Accepted'),
(22, 52, 'John Rev Baliton', '121 Street', 'jomarkulot76@gmail.com', '09647586454', 3, 0, 2, 1, 1, 1, 1, 0, '2024-10-16', '2024-10-17', 'REF-O2Q2Q8', '2024-10-13 22:43:16', 'Accepted'),
(23, 52, 'Poer Nasa', '1231 Street', 'kajsd7896@gmail.com', '09647587654', 12, 12, 12, 12, 12, 0, 12, 0, '2024-10-18', '2024-10-19', 'REF-D2KA9W', '2024-10-13 22:47:25', 'Accepted'),
(24, 52, 'Jomar Silog', '121 Street', 'higasd786@gmail.com', '09756453675', 1, 0, 1, 0, 0, 0, 1, 0, '2024-10-20', '2024-10-21', 'REF-QE41D9', '2024-10-13 22:50:59', 'Accepted'),
(25, 52, 'hrakjashdas', 'askhdgaskdgas', 'ksjhd78@gmail.com', '90328489372349', 1, 0, 0, 1, 1, 0, 0, 0, '2024-10-22', '2024-10-23', 'REF-TE8Y5Y', '2024-10-13 22:53:17', 'Accepted'),
(26, 52, 'klasjdk', 'ksadhgaksd', 'ljkhasd796@gmail.com', '09756453675', 1, 0, 1, 0, 0, 1, 0, 0, '2024-10-24', '2024-10-25', 'REF-LO4Q0I', '2024-10-13 22:56:33', 'Accepted');
...
--
ALTER TABLE `businessapplicationform`
  MODIFY `ApplicationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;

--
-- AUTO_INCREMENT for table `businessinformationform`
--
ALTER TABLE `businessinformationform`
  MODIFY `BusinessInfoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `business_features`
  MODIFY `BusinessFeatureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `reservations`
  MODIFY `revID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `roominfotable`
  MODIFY `roomID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
